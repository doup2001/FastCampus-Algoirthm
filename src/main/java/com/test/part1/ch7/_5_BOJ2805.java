 ...
 * - 둘째 줄에는 나무의 높이가 주어진다.
력* - 나무의 높이의 합은 항상 M보다 크거나 같기 때문에, 상근이는 집에 필요한 나무를 항상 가져갈 수 있다. 높이는 1,000,000,000보다 작거나 같은 양의 정수 또는 0이다.
 *
 * 4 7
 * 20 15 10 17
 * - 최대나 최소는 파라미터 서치(이분 검색)를 통해서 풀이
 */

public class _5_BOJ2805 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /// 높이를 0부터 증가시키면서, 잘려진 값들을 더한다.

        /// 정렬해서, 값들을 이분검색을 통해서 합산?
        /// binarySearch 를 통해, H보다 큰 쪽에서 값을 더하도록 계산
        Arrays.sort(arr);
